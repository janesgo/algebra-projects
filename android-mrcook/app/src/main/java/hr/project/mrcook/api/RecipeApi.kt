...
data class RecipeApi(
    ...
    @SerializedName("strIngredient1") val strIngredient01: String,
    @SerializedName("strIngredient2") val strIngredient02: String,
    @SerializedName("strIngredient3") val strIngredient03: String,
    @SerializedName("strIngredient4") val strIngredient04: String,
    @SerializedName("strIngredient5") val strIngredient05: String,
    @SerializedName("strIngredient6") val strIngredient06: String,
    @SerializedName("strIngredient7") val strIngredient07: String,
    @SerializedName("strIngredient8") val strIngredient08: String,
    @SerializedName("strIngredient9") val strIngredient09: String,
    ...
    @SerializedName("strMeasure1") val strMeasure01: String,
    @SerializedName("strMeasure2") val strMeasure02: String,
    @SerializedName("strMeasure3") val strMeasure03: String,
    @SerializedName("strMeasure4") val strMeasure04: String,
    @SerializedName("strMeasure5") val strMeasure05: String,
    @SerializedName("strMeasure6") val strMeasure06: String,
    @SerializedName("strMeasure7") val strMeasure07: String,
    @SerializedName("strMeasure8") val strMeasure08: String,
    @SerializedName("strMeasure9") val strMeasure09: String,
